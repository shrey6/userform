...
if (window.tplogs == true)
  try {
    console.groupCollapsed("Theme GreenSocks Logs");
  } catch (e) {}
...
if (window.tplogs == true)
  try {
    console.info("Build GreenSock SandBox for Theme Plugins");
    console.info("GreenSock TweenLite Engine Initalised by Theme Plugin");
  } catch (e) {}
